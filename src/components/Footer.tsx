        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg text-white">InpromptiFy</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li><Link href="/leaderboard" className="hover:text-gray-300 transition-colors">Leaderboard</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li><Link href="/security" className="hover:text-gray-300 transition-colors">Security</Link></li>
            </ul>
          </div>
        </div>
        <div className="border-t border-white/[0.06] mt-10 pt-6 flex items-center justify-between">
          <p className="text-sm text-gray-500">&copy; 2026 InpromptiFy. All rights reserved.</p>
          <a
