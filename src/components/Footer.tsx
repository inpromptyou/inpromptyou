        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-4">
              {/* X/Twitter */}
              <a href="https://x.com/InpromptiFyai" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-300 transition-colors" aria-label="X">
              ...
              {/* GitHub */}
              <a href="#" className="text-gray-600 hover:text-gray-300 transition-colors" aria-label="GitHub">
